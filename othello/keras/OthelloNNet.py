...
class OthelloNNet():
    def __init__(self, game, args):
        ...
        self.P = Dense(self.action_size, activation='softmax', name='P')(s_fc2)   # batch_size x self.action_size
        self.v = Dense(1, activation='tanh', name='v')(s_fc2)                    # batch_size x 1

        self.model = Model(inputs=self.input_boards, outputs=[self.P, self.v])
